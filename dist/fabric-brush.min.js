...
!function(t){t.CrayonBrush=t.util.createClass(t.BaseBrush,{size:0,opacity:.6,color:"#000000",_point:null,inkAmount:10,sep:5,initialize:function(i,s){s=s||{},this.canvas=i,this.width=s.width||i.freeDrawingBrush.width,this._point=new t.Point(0,0),this.color=s.color||i.freeDrawingBrush.color,this.opacity=s.opacity||i.contextTop.globalAlpha,this.inkAmount=s.inkAmount||this.inkAmount,this._latest=null,this._latestStrokeLength=0},changeColor:function(t){this.color=t},changeOpacity:function(t){this.opacity=t},onMouseDown:function(t){this.canvas.contextTop.globalAlpha=this.opacity,this.size=this.width/4+20,this.set(t)},onMouseMove:function(t){this.update(t),this.draw(this.canvas.contextTop)},onMouseUp:function(t){},set:function(i){this._latest?this._latest.setFromPoint(this._point):this._latest=new t.Point(i.x,i.y),t.Point.prototype.setFromPoint.call(this._point,i)},update:function(t){this.set(t),this._latestStrokeLength=this._point.subtract(this._latest).distanceFrom({x:0,y:0})},draw:function(i){var s,o,n,e,a,h,l,c,r,u,p,f,d,m,_;for(u=this._point.subtract(this._latest),p=Math.ceil(this.size/2),f=Math.floor(u.distanceFrom({x:0,y:0})/p)+1,u.normalize(p),d=this.sep*t.util.clamp(this.inkAmount/this._latestStrokeLength*3,1,.5),m=Math.ceil(this.size*this.sep),_=this.size/2,i.save(),i.fillStyle=this.color,i.beginPath(),s=0;m>s;s++)for(o=0;f>o;o++)n=this._latest.add(u.multiply(o)),e=t.util.getRandom(_),a=t.util.getRandom(2*Math.PI),c=t.util.getRandom(d,d/2),r=t.util.getRandom(d,d/2),h=n.x+e*Math.sin(a)-c/2,l=n.y+e*Math.cos(a)-r/2,i.rect(h,l,c,r);i.fill(),i.restore()}})}(fabric);
