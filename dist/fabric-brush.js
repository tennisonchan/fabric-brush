    ...
    _render: function() {
      ...
      function draw() {
        ...
        if (context._inkAmount > context._dripThreshold) {
          context._drips.push(new fabric.Drip(context.ctx, point, context._inkAmount / 2, context.color, context._strokeId));
        ...
        context.ctx.drawImage(context.brush._element, x, y, context.size, context.size);
